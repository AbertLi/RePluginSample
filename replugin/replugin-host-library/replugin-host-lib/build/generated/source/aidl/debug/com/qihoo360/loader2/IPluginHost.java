 ...
 * Original file: C:\\AndroidStudioWorkspace\\RePluginSample\\replugin\\replugin-host-library\\replugin-host-lib\\src\\main\\aidl\\com\\qihoo360\\loader2\\IPluginHost.aidl
 */
...
@Override public void unregPluginBinder(com.qihoo360.loader2.PluginBinderInfo info, android.os.IBinder binder) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean pluginUninstalled(com.qihoo360.replugin.model.PluginInfo info) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_pluginUninstalled, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_pluginUninstalled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_pluginExtracted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_sendIntent2Process = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_sendIntent2Plugin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_sendIntent2ProcessSync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_sendIntent2PluginSync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_isProcessAlive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_queryPluginBinder = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_queryPluginsReceiverList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_fetchServiceServer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_fetchManagerServer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getTaskAffinityGroupIndex = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getPidByProcessName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getProcessNameByPid = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_dump = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
}
...
public com.qihoo360.loader2.IPluginClient startPluginProcess(java.lang.String plugin, int process, com.qihoo360.loader2.PluginBinderInfo info) throws android.os.RemoteException;
...
public void regPluginBinder(com.qihoo360.loader2.PluginBinderInfo info, android.os.IBinder binder) throws android.os.RemoteException;
public void unregPluginBinder(com.qihoo360.loader2.PluginBinderInfo info, android.os.IBinder binder) throws android.os.RemoteException;
/**
    * 注册某插件下所有静态声明的的 receiver 到常驻进程
    */
...
public boolean pluginUninstalled(com.qihoo360.replugin.model.PluginInfo info) throws android.os.RemoteException;
